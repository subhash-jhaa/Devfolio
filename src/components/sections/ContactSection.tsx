...
import { SLIDE_UP, STAGGER_CONTAINER, VIEWPORT_CONFIG, SOCIAL_HOVER, SOCIAL_TAP, SUCCESS_POP } from '@/lib/animations';
    ...
    >
      <div className="rounded-3xl p-4 sm:p-8 border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-900 shadow-xl overflow-hidden">
        ...
        <div className="flex items-center gap-2 mb-5 pb-[18px] border-b border-header-border">
          <div className="w-2.5 h-2.5 rounded-full bg-dot-green animate-pulse" />
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            <motion.div variants={SLIDE_UP}>
              ...
              <input
                ...
                } text-input-text placeholder:text-input-placeholder outline-none focus:border-text-link focus:ring-2 focus:ring-text-link/10 transition-all duration-200`}
              />
            </motion.div>
            <motion.div variants={SLIDE_UP}>
          ...
          <motion.div variants={SLIDE_UP} className="mb-4">
          ...
          <motion.div variants={SLIDE_UP}>
            {status !== 'sent' ? (
              ...
              <motion.div 
                variants={SUCCESS_POP}
                initial="hidden"
                animate="visible"
                className="w-full flex items-center justify-center gap-2 mt-1 rounded-lg py-[13px] border border-header-border text-[13px] font-medium bg-green-500/10 dark:bg-green-500/20 text-green-700 dark:text-green-400"
              >
